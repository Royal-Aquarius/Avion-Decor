...
const Footer = () => {
  return (
    <footer className="text-gray-400 bg-[#2A254B] body-font">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-400 hover:text-white">New Arrival</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-white">Best Selller</a>
              </li>
              <li>
